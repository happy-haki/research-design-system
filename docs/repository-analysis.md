...
| sipe-team/side | Monorepo DS operations | workspace-oriented structure, Storybook docs, Vitest, release automation, and package-oriented boundaries | monorepo baseline + docs workflow + CI |
